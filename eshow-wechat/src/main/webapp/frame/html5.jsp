...
<div class="html_contentbox">
    <div class="html_content">
        ...
        <div class="html_cont_block">
            ...
            <div class="html_cont_bd">
                <ul class="html_nav">
                    <li class="fl"><a class="nav_active" href="${ctx}/ui/index.html">基础样式</a></li>
                    <li class="fl"><a class="" href="${ctx}/ui/ui.html">UI组件</a></li>
                    <li class="fr"><a href="${ctx}/ui/js.html">js插件</a></li>
