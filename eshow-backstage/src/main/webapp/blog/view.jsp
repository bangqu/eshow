		...
		<div class="row-fluid">
			...
			<div class="span10">
				<ul class="breadcrumb">
					...
					<li><a href="${ctx}/blog/">日志管理</a> <span
						class="divider">/</span>
					</li>
				...
				<div class="well com">
					...
					<ul id="myTab" class="nav nav-tabs">
						<li class="active"><a data-toggle="tab"
							href="<c:url value='/blog'/>">日志列表</a>
						</li>
						<li><a data-toggle="tab"
							href="<c:url value='/blog/mine'/>">我的日志</a>
						</li>
						<li><a data-toggle="tab"
							href="<c:url value='/blog/workmate'/>">同事的日志</a>
						</li>
					</ul>
					<div id="blogView">
						<div id="mainUse">
							<div>
								<a href="<c:url value='/user/view/${view.blog.user.id}'/>"><img
							...
							<div class="submenu">
								<a href="/eshow/twitter/workmate/${view.blog.user.id}">他的微博</a>&nbsp;&nbsp;|&nbsp;&nbsp;
								<a href="/eshow/blog/workmate/${view.blog.user.id}">他的日志</a>&nbsp;&nbsp;|&nbsp;&nbsp;
								<a href="/eshow/topic/workmate/${view.blog.user.id }">他的话题</a>
							</div>
						</div>
						<div class="info">
							${view.blog.title}
								<c:if test="true">
									<a href="<c:url value='/blog/edit/${view.blog.id}'/>">修改</a>&nbsp;&nbsp;|&nbsp;&nbsp;
						...
						<div class="tips">
							...
							<span class="3">(分类： <c:if
									...
									<a
										href="<c:url value="/blog/c/${view.blog.category.id}"/>">${view.blog.category.name}</a>
