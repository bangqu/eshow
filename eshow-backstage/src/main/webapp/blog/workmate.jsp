				...
				<div class="well com">
					<div class="page-header">
						...
						<ul id="myTab" class="nav nav-tabs">
							<li><a data-toggle="tab" href="<c:url value='/blog'/>">日志列表</a></li>
							<li><a data-toggle="tab" href="<c:url value='/blog/mine'/>">我的日志</a></li>
							<li class="active"><a data-toggle="tab" href="<c:url value='/album/workmate'/>">同事的日志</a></li>
						</ul>
						<div id="blog">
										...
										<div class="cont">
											...
											<div class="time">
												<c:if test="${category.id==null}">[默认分类] </c:if>
												 ...
												 <a href="<c:url value="/blog/c/${category.id}"/>">[${category.name}]</a></c:if>&nbsp;&nbsp;|&nbsp;&nbsp;发表于
