...
<head>
	<title>${view.category.name}_日志</title>
			...
			<div class="span10">
				...
				<div class="well com">
					<div class="page-header">
						...
						<h3 class="yahei">日志模块</h3>
					</div>
						<ul id="myTab" class="nav nav-tabs">
							<li class="active"><a data-toggle="tab" href="<c:url value='/blog'/>">日志列表</a></li>
							<li><a data-toggle="tab" href="<c:url value='/blog/mine'/>">我的日志</a></li>
							<li><a data-toggle="tab" href="<c:url value='/blog/workmate'/>">同事的日志</a></li>
						</ul>
						<div id="blog">
							<s:action name="blog!search" id="newsBlogList"
								executeResult="false">
								<s:param name="query.order">addTime</s:param>
								<s:param name="query.categoryId">${view.category.id}</s:param>
									...
									<li id="blog${id}" onmouseover='this.style.backgroundColor ="#f9f9f9"'
										...
										<div class="cont">
											<div class="tips">
												...
												<c:if test="true">
													<span> <a
														href="<c:url value='/blog/edit/${id}'/>">修改</a>&nbsp;&nbsp;|&nbsp;&nbsp;
											...
											<div class="contxt">
												...
												<p class="r">
													<a href="<c:url value='/blog/view/${id}'/>">查看全文</a>
												</p>
											</div>
										</div>
										<div class="c"></div>
