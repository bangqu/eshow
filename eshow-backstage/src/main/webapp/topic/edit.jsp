...
<div class="home_wrapper ">
    ...
    <div class="home_content">
        ...
        <div class="home_dis">
            <s:form id="topicForm" action="topic!update.action" method="post" cssClass="form-horizontal"
                    namespace="">
                ...
                <%--<div class="home_block product_cont">--%>
                    ...
                    <%--<div class="add_info clearfix">--%>
                        ...
                        <%--<input type="hidden" name="boardId" id="boardId" value="${view.topic.board.id}">--%>

                        <%--<div class="add_info_input fl input_name_down input_name_down_b classic">--%>
                            <%--<span>${view.topic.board.name}</span>--%>
                        <%--</div>--%>
                    ...
                    <%--<textarea class="" id="content" placeholder="请输入话题名称..."--%>
                              <%--name="topic.content" value="${view.topic.content}" style="height: 400px;width: 700px"--%>
                              <%--onFocus="if (placeholder =='请输入话题内容...'){placeholder ='';this.style.color='#163547'}"--%>
                              <%--onBlur="if (placeholder ==''){placeholder='请输入话题内容...';this.style.color='#77848e'}">${view.topic.content}--%>
                    <%--</textarea>--%>
                    <%--</div>--%>
                        ...
                        <div class="col-sm-10">
                            <select name="boardId" id="boardId" class="form-control">
                                ...
                                <s:iterator value="%{#boardList.boards}"  var="board">
                                    <option  value="${id}"
                                         <s:if test="%{id == #view.topic.board.id}">selected="selected"</s:if>
                                        >${name}</option>
                    ...
                    <div class="row input_row">
                        ...
                        <div class="col-xs-10 home_right">
							<textarea class="form-control" id="content" placeholder="请输入话题内容..."
                                      ...
                                      onFocus="if (placeholder =='请输入话题内容...'){placeholder ='';this.style.color='#163547'}"
                                      onBlur="if (placeholder ==''){placeholder='请输入话题内容...';this.style.color='#77848e'}">${view.topic.content}</textarea>
                        </div>
...
<div class="downmenu_hides">
    <ul class="promoter_select_down">
        <li class="promoter_down_li">
            <input type="text" value="输入您要搜索的分类" onFocus="if (value =='输入您要搜索的分类'){value ='';this.style.color='#000'}"
                   onBlur="if (value ==''){value='输入您要搜索的分类';this.style.color='#c1c8ce'}"/>
        </li>
        <%--<s:action name="board!search" var="boardList" executeResult="false">--%>
            <%--<s:param name="query.enabled">true</s:param>--%>
            <%--<s:param name="query.order">sequence</s:param>--%>
