		...
		<div class="row-fluid">
			...
			<div class="span10">
				<ul class="breadcrumb">
					...
					<li><a href="${ctx}/album/">相册中心</a> <span
						class="divider">/</span>
					</li>
				...
				<div class="well com">
					<div class="page-header">
						<div class="pull-right">
							<a href="<c:url value='/album/add'/>"
								class="btn btn-primary"> 添加</a>
						</div>
						<h3 class="yahei">${view.album.name}相册</h3>
					</div>
					<ul id="myTab" class="nav nav-tabs">
						<li><a data-toggle="tab" href="<c:url value='/album'/>">相册列表</a>
						</li>
						<li class="active"><a data-toggle="tab"
							href="<c:url value='/album/view'/>">查看相册</a>
						</li>
						<li><a data-toggle="tab"
							href="<c:url value='/album/edit'/>">修改相册</a>
						</li>
					</ul>
				</div>
				<div id="celebrity">
						...
						<s:iterator value="%{#photoList.photos}" status="rowStatus">
							<li style="background-color: #f9f9f9" id="photo${id}"
								...
								<div class="cont" style="color: #999" align="center">
									...
									<br /> <a href="<c:url value='/photo/view/${id}'/>">评论(${commentSize})</a>|
									<a href="<c:url value='/photo/edit/${id}'/>">修改</a>| <a
