...
<link rel="stylesheet" href="${dll}/manage/styles/admin.css">
    <title><decorator:title />_eshow后台管理系统</title>
<script src="http://apps.bdimg.com/libs/jquery/2.1.1/jquery.min.js"></script>

<script src="${dll}/scripts/amazeui.min.js"></script>
<decorator:head />
</head>
<body
...
<header class="am-topbar admin-header">
  <div class="am-topbar-brand">
    <strong>ESHOW</strong> <small><a href="${ctx}/index">网站管理平台</a></small>
  </div>
