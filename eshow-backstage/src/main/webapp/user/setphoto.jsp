...
<head>
	<title>修改头像</title>
	<link rel="stylesheet"
		href="<c:url value='/styles/profile.css'/>" type="text/css" />
		...
		<div class="row-fluid">
			...
			<div class="span10">
				<ul class="breadcrumb">
					...
					<li><a href="${ctx}/user/">用户管理</a> <span class="divider">/</span></li>
				...
				<div class="well com">
					<div class="page-header">
						<div class="pull-right">
							<a href="<c:url value='/user/add'/>" class="btn btn-primary">添加</a>
						</div>
					...
					<div class="navbar">
			          <div class="navbar-inner"> 
						<ul class="nav">
							<li><a href="<c:url value='/user'/>">用户列表</a></li>
							<li><a href="<c:url value='/user/edit'/>">修改资料</a></li>
							<li><a href="<c:url value='/user/password'/>">修改密码</a></li>
							<li  class="active"><a href="<c:url value='/user/setphoto'/>">修改头像</a></li>
						</ul>
					</div>
				</div>
							...
							<div class="control-group">
								...
								<div class="controls">
									<c:if test="${view.user.photo==null}">
										<a
											href="<c:url value="/user/view/${view.user.username}"/>"><img
											src="${pageContext.request.contextPath}/common/images/user50-50.jpg"
											alt="${view.user.nickname}" /> </a>
									</c:if>
									<c:if test="${view.user.photo!=null}">
										<a href="<c:url value="/user/view/${username}"/>"><img
