...
public class Match {
	 ...
	 * @return 匹配到的数据 or 空
	 */
	public static List<String> match2(String text, String regEx) {

		List<String> result = new ArrayList<String>();

		Pattern pattern = Pattern.compile(quote(regEx), Pattern.DOTALL);
	...
	public static void main(String[] args) {
		...
		System.out
				.println(match(
						"http://www.youtube.com/watch?v=gs-mQVAHbl2UWM&feature=related",
						YOUTUBE_REGEX));
		System.out.println(match(
				"http://group.qq.com/cgi-bin/groupbaseinfo?groupid=122121",
				"http://([\\w-]+\\.)+[\\w-]+(/[\\w- ./?%&=]*)?"));
