        ...
        <td>
            <div id="content">
                ...
                <script language=javascript type=text/javascript>
                    ...
                    var imgs='${pageContext.request.contextPath}/wxdayou/images/1.jpg|${pageContext.request.contextPath}/wxdayou/images/2.jpg|${pageContext.request.contextPath}/wxdayou/images/3.jpg|${pageContext.request.contextPath}/wxdayou/images/4.jpg';
                    var urls='#|#|#|#';
                    var pw = 980;
                    var ph = 313;
                    var sizes = 14;
