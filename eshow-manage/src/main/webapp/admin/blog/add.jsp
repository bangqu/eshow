				...
				<div class="well com">
					<div class="page-header">
						<div class="pull-right">
							<a href="<c:url value='/admin/blog/add.jsp'/>" class="btn btn-primary">添加</a>
						</div>
						<h3 class="yahei">添加日志</h3>
					</div>
					<ul id="myTab" class="nav nav-tabs">
						<li class="active"><a data-toggle="tab" href="<c:url value='/admin/blog'/>">日志列表</a></li>
						<li><a data-toggle="tab" href="<c:url value='/admin/blog/mine.jsp'/>">我的日志</a></li>
						<li><a data-toggle="tab" href="<c:url value='/admin/blog/workmate.jsp'/>">同事的日志</a></li>
					</ul>
					<form class="form-horizontal" action="blog!save" method="post"
						...
						<fieldset>
							...
							<div class="control-group">
								...
								<div class="controls">
									<s:action name="category!list" id="select01"
										executeResult="false" />
