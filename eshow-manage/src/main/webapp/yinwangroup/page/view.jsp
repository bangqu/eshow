...
<div class="wp clearfix mt25">
	<%@ include file="left.jsp"%>
	 <div class="aboutr">
		<h3>精彩视频</h3>  
		<p><embed src="http://player.youku.com/player.php/sid/XNjY0NTk0NjAw/v.swf" allowFullScreen="true" quality="high" width="800" height="500" align="middle" allowScriptAccess="always" type="application/x-shockwave-flash"></embed>
			 	</p> 
	 </div>
