...
<s:action name="photo!view" var="view" executeResult="false">
</s:action>
<c:set var="myid">
	<authz:authentication operation='id' />
</c:set>
<c:if test="${param.id==null}">
	<script>location.href="<c:url value='/album'/>";</script>
</c:if>
...
<head>
	...
	<link rel="stylesheet" href="<c:url value='/styles/album.css'/>"
		type="text/css" />
		...
		<div class="row-fluid">
			...
			<div class="span10">
				<ul class="breadcrumb">
					...
					<li><a href="${ctx}/photo/">图片管理</a> <span class="divider">/</span>
					</li>
				...
				<div class="well com">
					<div class="page-header">
						<div class="pull-right">
							<a href="<c:url value='/photo/add'/>" class="btn btn-primary">发布</a>
						</div>
						<h3 class="yahei"><img src="<c:url value='/images/app_list_album.gif'/>" />
					...
					<div id="photo${view.photo.id}">
						<div style="margin: 10px 0 20px 0px">
							...
							<span style="margin-left: 10px;"><a
								href="<c:url value='/photo/edit/${view.photo.id}'/>">修改</a>
							</span>
							<span style="margin-left: 10px;"><a
						...
						<div class="user-comment">
							<div class="replies">
								<div id="commContainer">
									<dl class="replies">
										<s:action name="photoComment!search" var="photoCommentList"
											executeResult="false">
		...
		<div id="mainarea">
			<div id="mainarea_bg">
				<div id="content">
					<div id="mainTop">
						<h2>
							<img src="<c:url value='/images/app_list_album.gif'/>" />
							相册--${view.photo.name}
						</h2>
					</div>
					<div id="mainTab">
						<ul>
							<li>
								<span class="txt6"><a
									href="<c:url value='/album'/>">相册</a> </span>
							</li>
							<li>
								<span class="txt6"><a
									href="<c:url value='/photo'/>">图片列表</a> </span>
							</li>
							<li class="navtxt">
								<a href="<c:url value='/photo/add'/>">上传图片</a>
							</li>
						</ul>
					</div>
					<div id="photo${view.photo.id}">
