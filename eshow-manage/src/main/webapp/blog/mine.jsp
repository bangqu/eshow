			...
			<div class="span10">
				...
				<div class="well com">
					<div class="page-header">
						...
						<h3 class="yahei">我的日志</h3>
					</div>
					<ul id="myTab" class="nav nav-tabs">
						<li><a data-toggle="tab" href="<c:url value='/blog'/>">日志列表</a>
						</li>
					...
					<div id="blog">
						<s:action name="blog!search" var="newsBlogList"
							executeResult="false">
						...
						<ul class="flist">
							<s:iterator value="%{#newsBlogList.blogs}" status="rowStatus">
								<li id="blog${id}"
									...
									<div class="avatar">
										<a href="<c:url value="/user/view/${user.id}"/>"> <c:if
									...
									<div class="cont">
										...
										<div class="time">
											...
											<c:if test="${category.id!=null}">
												<a href="<c:url value="/blog/c/${category.id}"/>">[${category.name}]</a>
											</c:if>
											&nbsp;&nbsp;|&nbsp;&nbsp;发表于
