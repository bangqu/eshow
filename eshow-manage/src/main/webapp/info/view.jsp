		...
		<div class="row-fluid">
			...
			<div class="span10">
				<ul class="breadcrumb">
					...
					<li><a href="${ctx}/info/">信息中心</a> <span class="divider">/</span></li>
					<li class="active">查看信息</li>
				</ul>
				<div class="well com"> 
					<div class="page-header">
						<div class="pull-right">
							<a href="<c:url value='/info/add'/>"
								class="btn btn-primary"> 添加</a>
						</div>
						<h3 class="yahei">查看信息</h3>
					</div>
					<ul id="myTab" class="nav nav-tabs">
						<li class="active"><a data-toggle="tab" href="<c:url value='/info'/>">信息列表</a>
					</li>
					</ul>
					<div id="accContent">
						<div class="title">
							...
							<div class="fr span3">
								<a href="<c:url value='/info/edit/${view.info.id}'/>">修改</a> | <a href="javascript:window.history.back()">返回上一级</a>
							</div>
						</div>
						<div class="contxt">
							${view.info.content}
