...
<s:action name="productCategory!view" var="view" executeResult="false">
</s:action>
<head>
<title>${view.productCategory.name}_产品</title>
<link rel="stylesheet" href="<c:url value='/styles/product.css'/>"
	type="text/css" />
</head>
<body>
		...
		<div class="row-fluid">
			...
			<div class="span10">
				<ul class="breadcrumb">
					...
					<li><a href="${ctx}/product/">产品管理</a> <span
						class="divider">/</span>
					</li>
				...
				<div class="well com">
					...
					<ul id="myTab" class="nav nav-tabs">
						<li class="active"><a data-toggle="tab"
							href="<c:url value='/product'/>"> 产品列表</a>
						</li>
						<li><a data-toggle="tab"
							href="<c:url value='/productCategory'/>"> 产品分类</a>
						</li>
					</ul>
					<div id="celebrityList">
						<s:action name="product!search" var="productList"
							executeResult="false">
								...
								<li class="productlist" id="product${id}">
									...
									<div class="list-content">
										...
										<div class="contxt">
											...
											<a href="${ctx}/product/view/${id}">查看全文</a>
										</div>
										<div class="time">
											分类:
