...
<div class="container mt">
    <div class="side">
      <ul class="nav nav-list ">
        ...
        <li class="active"><a href="/admin/project/"><span class="glyphicon glyphicon-th-large"></span> 项目管理</a></li>
        <li class=""><a href="/admin/category/"><span class="glyphicon glyphicon-paperclip"></span> 项目类别管理</a></li>
        <li class=""><a href="/admin/info/"><span class="glyphicon glyphicon-eye-open"></span> 信息页</a></li>
	</ul>
</div>
