...
<head>
    <title>日志</title>
    <link rel="stylesheet" href="<c:url value='/admin/styles/profile.css'/>"
          type="text/css"/>
    ...
    <div class="row-fluid">
        ...
        <div class="span10">
            <ul class="breadcrumb">
                ...
                <li><a href="${ctx}/admin/user/">用户管理</a> <span
            ...
            <div class="well com">
                <div class="page-header">
                    ...
                    <ul id="myTab" class="nav nav-tabs">
                        <li class="active"><a data-toggle="tab" href="<c:url value='/admin/user'/>">用户列表</a>
                        </li>
