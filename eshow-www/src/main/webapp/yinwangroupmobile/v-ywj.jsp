    ...
    <body>
        <div class="header">
            <i onclick="window.history.back();" class="back"></i>
                <h3 class="name">银湾智能</h3>
                 <span class="mum" onclick="showside();">   </span>
        </div>
        <div  class="c-img ">
            <img src="static/images/in-ywj/img1.png">
            <img src="static/images/in-ywj/img2.png">
            <img src="static/images/in-ywj/img3.png">
            <img src="static/images/in-ywj/img4.png">
        </div>
