    ...
    <body>
        <div class="header">
            <i onclick="window.history.back();" class="back"></i>
                <h3 class="name">福利宝</h3>
                 <span class="mum" onclick="showside();">   </span>
        </div>
        <div  class="c-img ">
           <img src="static/images/in-flb/img1.png">
            <img src="static/images/in-flb/img2.png">
            <img src="static/images/in-flb/img3.png">
            <img src="static/images/in-flb/img4.png">
            <img src="static/images/in-flb/img5.png">
