    ...
    <body>
        <div class="header">
            <i onclick="window.history.back();" class="back"></i>
                <h3 class="name">精彩图片</h3>
            <span class="mum" onclick="showside();">   </span>
        </div>
            <ul class="videolist">
                <li>
                    <embed src="http://player.youku.com/player.php/sid/XNjY0NTk0NjAw/v.swf"
                           allowfullscreen="true" quality="high" width="100%" height="250" align="middle"
                           allowscriptaccess="always" type="application/x-shockwave-flash"
                           title="Adobe Flash Player">
                        <span>家•银湾物业</span>
                </li>
                <li>
                    <embed src="http://player.youku.com/player.php/sid/XNzg3MTQ2MDY0/v.swf"
                           allowfullscreen="true" quality="high" width="100%" height="250"
                           align="middle" allowscriptaccess="always" type="application/x-shockwave-flash">
                        <span>江西开车看房报道银湾智慧社区体验馆锦绣春天店</span>
                </li>
                <li>
                    <embed src="http://player.youku.com/player.php/sid/XODE3NzkwMTA4/v.swf"
                           allowfullscreen="true" quality="high" width="100%" height="250"
                           align="middle" allowscriptaccess="always" type="application/x-shockwave-flash"
                           title="Adobe Flash Player">
                ...
                <li>
                    <embed src="http://player.youku.com/player.php/sid/XODI3NjU1NjQ4/v.swf"
                           allowfullscreen="true" quality="high" width="100%" height="250"
            ...
            <div class="comm">
                <dl>
                    ...
                    <dd class="clear">
                        ...
                        <a href="http://wanlixing.yinwan.com/m/index.jsp">智慧社区万里行</a>
