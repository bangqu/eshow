    ...
    <body>
        <div class="header">
            <i onclick="window.history.back();" class="back"></i>
                <h3 class="name">仁盈科技</h3>
                 <span class="mum" onclick="showside();">   </span>
        </div>
        <div  class="c-img clear">
            <img src="static/images/in-rykj/img1.png">
            <img src="static/images/in-rykj/img2.png">
        </div>
            ...
            <div class="c-img">
                <img src="static/images/in-rykj/img3.png">
                <img src="static/images/in-rykj/img4.png">
            </div>
            <div class="texbox">
                <p>电脑版解决方案：1台迷你证件采集器+1套定制软件。</p>
                <p>  手机版解决方案：1台手机+1套定制软件。</p>
                <p> 全业务解决方案：1台一体化智能外设+1套定制软件。</p>
            </div>
        <div class="c-img"><img src="static/images/in-rykj/img5.png"></div>
