    ...
    <body>
        <div class="header">
            <i onclick="window.history.back();" class="back"></i>
                <h3 class="name">邻里店</h3>
                 <span class="mum" onclick="showside();">   </span>
        </div>
        <div  class="c-img ">
           <img src="static/images/in-lld/img1.png">
            <img src="static/images/in-lld/img2.png">
            <img src="static/images/in-lld/img3.png">
            <img src="static/images/in-lld/img4.png">
            <img src="static/images/in-lld/img5.png">
        </div>
