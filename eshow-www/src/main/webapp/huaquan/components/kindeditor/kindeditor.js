...
KE.setting = {
	...
	minChangeSize : 5,
	items : [
		 'fullscreen', 'title', 'fontname', 'fontsize', 'textcolor', 'bgcolor', 
		 'justifyleft', 'justifycenter', 'justifyright',
		'justifyfull',  'insertorderedlist', 'insertunorderedlist', 'bold',
		'italic', 'underline',  'removeformat', 'image','media',
...
KE.plugin['image'] = {
	...
	click : function(id) {
		...
		this.dialog = new KE.dialog({
			id : id,
			cmd : 'image',
			file : '../plugins/image/image.html?id=' + id + '&ver=' + KE.version,
			width : 400,
			height : 230,
			loadingMode : true,
			title : KE.lang['image'],
