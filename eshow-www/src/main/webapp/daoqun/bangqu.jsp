...
<link rel="stylesheet" href="${daoqun}/styles/bangqu.css"  />
...
<body>
	...
	<div class="wapper">
		<div class="m_intro yahei">
			<div class="i1">
				<img class="i1_logo" src="${daoqun}/images/bangqu/pic_logo.jpg">
				<p class="f_tac">
				...
				<div class="img">
					<img src="${daoqun}/images/bangqu/pic_a.jpg">
				</div>
			</div>
			<div class="i0"></div>
			<div class="i2">
				...
				<ul class="f-cb">
					<li class="odd first f-cb">
						<div class="img">
							<img src="${daoqun}/images/bangqu/pic_b.jpg">
						</div>
						<div class="txt">
							<h3>个人知识分享工具</h3>
							<div class="user f-cb">
					...
					<li class="even f-cb">
						<div class="img">
							<img src="${daoqun}/images/bangqu/pic_c.jpg">
						</div>
						<div class="txt">
							<h3>朋友关系管理系统FRM</h3>
							<div class="user f-cb">
					...
					<li class="odd first f-cb">
						<div class="img">
							<img src="${daoqun}/images/bangqu/pic_d.jpg">
						</div>
						<div class="txt">
							<h3>出售自己服务技能</h3>
							<div class="user f-cb">
					...
					<li class="even f-cb">
						<div class="img">
							<img src="${daoqun}/images/bangqu/pic_e.jpg">
						</div>
						<div class="txt">
							<h3>朋友圈的问答系统</h3>
							<div class="user f-cb">
